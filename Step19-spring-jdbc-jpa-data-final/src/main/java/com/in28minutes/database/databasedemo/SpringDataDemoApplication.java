...
public class SpringDataDemoApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		logger.info("findByLocation--> {} :" ,repository.findByLocationAndName("Hyderabad","Ranga"));

		logger.info("findByLocationOrName--> {} :" ,repository.findByLocationOrName("Hyderabad","Ran2ga1"));
